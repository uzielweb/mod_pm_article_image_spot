...
$title_tag = $params->get('title_tag');

$subtitle_tag = $params->get('subtitle_tag');
...
if ($params->get('menu_item_title_origin') == 'menu_title'){
 $title = $doc->getTitle();
}

if ($params->get('menu_item_text_origin') == 'menu_description'){
...
if ($params->get('show_cat_title') == 'from_cat_title'){
$title = $result_cat->title;
}
if ($params->get('show_cat_text') == 'from_cat_description'){
$text = $result_cat->description;
}

if ($params->get('show_cat_title') == 'from_page_title_in_categories'){
$title = $doc->getTitle();
}
if ($params->get('show_cat_text') == 'from_page_description_in_categories'){
$text = $doc->getDescription();
}
...
<div id="spot_<?php echo $module->id; ?>" class="image_spot" style="height: <?php echo $height; ?>;<?php echo $background_spot; ?>">
    ...
    <?php if (($title != '') or ($text != '')) : ?>

    <?php if (($params->get('show_title') != 'none') or ($params->get('show_text') != 'none') or ((($params->get('show_cat_title') != 'none') and ($is_category == 'true')) or (($params->get('show_cat_text') != 'none') and ($is_category == 'true')))) : ?>
    ...
    <div class="info_spot" id="info_spot_<?php echo $module->id; ?>">
        ...
        <<?php echo $subtitle_tag;?> class="text_spot article_spot_text">
        ...
        <?php if (($params->get('show_cat_title')!= 'none') and ($is_category == 'true')) : ?>

        <<?php echo $title_tag;?> class="title_spot cat_spot_title">
        ...
        <?php if (($params->get('show_cat_text') != 'none') and ($is_category == 'true')) : ?>

        <<?php echo $subtitle_tag;?> class="text_spot cat_spot_text">
